...
trap 'rm -rf "$tmp"' EXIT
cd "$root"
cp index.html keyspace.html validator.html art-studio.html terrarium.html louisiana.html glendora.html manifest.toml manifest.webmanifest webxdc.js sw.js "$tmp/"
