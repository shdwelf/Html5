...
export default defineConfig({
  ...
  build: {
    rollupOptions: {
      // In the merged Html5 repository the root index.html is the SITE-K app.
      // Build the workbench's Vite entry instead; scripts/build-xdc.mjs
      // packages it as the Webxdc's index.html root.
      input: path.resolve(__dirname, "bip39-haiku-workbench.html"),
    },
  },
  resolve: {
    alias: {
